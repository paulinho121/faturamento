...
-- Comissão de vendedores: p_data_inicio/p_data_fim são escolhidos livremente
-- pelo diretor (não precisa ser mês calendário nem o ciclo 21-20). O
-- vendedor também pode chamar esta função — nesse caso só recebe a própria
-- linha (join com vendedores filtra por v.profile_id = auth.uid()).
