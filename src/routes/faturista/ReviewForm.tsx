...
export function ReviewForm({
  ...
  return (
    <form
      ...
      className="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-level2 p-lg space-y-lg"
    >
      <div className="flex items-center justify-between">
        <h3 className="font-title-md text-title-md text-on-surface">Revisar lançamento</h3>
        <span className="font-label-md text-label-md text-on-secondary-container">NF #{form.numeroNf}</span>
      </div>
      ...
      <div className="grid grid-cols-1 gap-md md:grid-cols-2">
        ...
        <Field label="Meio de Pagamento" required>
          <select
        ...
        <Field label={`Valor — ${formatCurrency(form.valor || 0)}`}>
          <input
            type="number"
            step="0.01"
            value={form.valor}
