    ...
    >
      ...
      <div className="mb-lg bg-surface-container-lowest border border-outline-variant rounded-xl shadow-level2 p-lg">
        <div className="mb-lg flex items-center gap-sm">
          ...
          <div>
            <h3 className="font-title-md text-title-md text-on-surface">Enviar Pedido</h3>
            <p className="font-label-md text-label-md text-on-surface-variant">
              Anexe o PDF assim que fechar a venda — entra direto na fila do faturista.
            </p>
          </div>
        </div>
          ...
          <div className="mt-lg border-t border-outline-variant pt-md">
            ...
            <div className="space-y-sm">
              {meusPedidos.map((p) => (
                <div
                  key={p.id}
                  className="flex flex-wrap items-center justify-between gap-sm rounded-lg border border-outline-variant p-sm transition-colors hover:bg-surface-container-low"
                >
                  <div className="flex min-w-0 items-center gap-sm">
                    <span
                      className={`material-symbols-outlined shrink-0 text-[20px] ${
                        p.status === 'faturado' ? 'text-tertiary' : 'text-amber-600'
                      }`}
                    >
                      {p.status === 'faturado' ? 'check_circle' : 'schedule'}
                    </span>
                  ...
                  <span
                    className={`shrink-0 rounded-full px-sm py-0.5 font-label-md text-label-md ${
